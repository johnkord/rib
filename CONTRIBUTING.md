...
7. Run backend tests in a disposable database: `make test`
8. Format & lint: `cargo fmt --all && cargo clippy --all-targets -- -D warnings`
...
- Use `make test` locally so integration fixtures do not pollute the development database
